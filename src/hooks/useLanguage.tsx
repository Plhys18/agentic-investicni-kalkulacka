...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'mortgage.interestPrincipalRatio': { cs: 'Poměr úroků/jistiny', en: 'Interest/principal ratio' },
  ...
  // DCA
  'dca.selectAssets': { cs: 'Vyberte aktiva pro DCA', en: 'Select assets for DCA' },
  ...
  'dca.expectedReturn': { cs: 'Očekávaný roční výnos', en: 'Expected annual return' },
  ...
  'comp.cumulativeCF': { cs: 'Celkový cash flow', en: 'Cumulative cash flow' },
  ...
  'tax.grossVsNet': { cs: 'Hrubá vs. čistá hodnota', en: 'Gross vs Net Value' },
